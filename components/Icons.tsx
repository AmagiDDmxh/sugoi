...
// Twitter is now X, LOL!
function X(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
      className="prefix__r-18jsvk2 prefix__r-4qtqp9 prefix__r-yyyyoo prefix__r-16y2uox prefix__r-8kz0gk prefix__r-dnmrzs prefix__r-bnwqim prefix__r-1plcrui prefix__r-lrvibr prefix__r-lrsllp"
      width="1em"
      height="1em"
      {...props}
    >
...
export const Icons = { X, Love, spinner: Loader2Icon }
